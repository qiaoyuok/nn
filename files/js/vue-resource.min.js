...
!function(t, e) {
    ...
    function w(t, e, n) {
        for (var o in e)
            n && (h(e[o]) || tt(e[o])) ? (h(e[o]) && !h(t[o]) && (t[o] = {}),
            tt(e[o]) && !tt(t[o]) && (t[o] = []),
            ...
            expand: function(o) {
                return t.replace(/\{([^\{\}]+)\}|([^\{\}]+)/g, function(t, r, i) {
                    if (r) {
                        var u = null
                          , s = [];
                        if (e.indexOf(r.charAt(0)) !== -1 && (u = r.charAt(0),
                        r = r.substr(1)),
                        r.split(/,/g).forEach(function(t) {
                            var e = /([^:\*]*)(?::(\d+)|(\*))?/.exec(t);
                            s.push.apply(s, j(o, u, e[1], e[2] || e[3])),
                            n.push(e[1])
                        }),
                        u && "+" !== u) {
                            var a = ",";
        ...
        if (E(r) && "" !== r)
            if ("string" == typeof r || "number" == typeof r || "boolean" == typeof r)
                ...
                Array.isArray(r) ? r.filter(E).forEach(function(t) {
                    ...
                    E(r[t]) && (u.push(encodeURIComponent(t)),
                    u.push(P(e, r[t].toString())))
                }),
    ...
    function R(t, e, n) {
        ...
        y(e, function(e, u) {
            o = f(e) || tt(e),
            n && (u = n + "[" + (i || o ? u : "") + "]"),
            !n && r ? t.add(e.name, e.value) : o ? R(t, e, u) : t.add(u, e)
        })
    }
    function A(t) {
        var e = t.match(/^\[|^\{(?!\{)/)
    ...
    function L(t) {
        var n = this || {}
          , r = vt(n.$vm);
        return b(t || {}, n.$options, L.options),
        L.interceptors.forEach(function(t) {
            r.use(t)
        }),
    ...
    ;
    var G, V = {}, _ = V.hasOwnProperty, z = [], K = z.slice, Q = !1, Y = "undefined" != typeof window, Z = function(t) {
        var e = t.config
          , n = t.nextTick;
        G = n,
        Q = e.debug || !e.silent
        ...
        var n = e(t);
        return a(t.root) && !n.match(/^(https?:)?\//) && (n = t.root + "/" + n),
        n
    }, ot = function(t, e) {
    ...
    var it = function(t) {
      ...
      , at = function(t, e) {
        d(t.body) ? t.headers.delete("Content-Type") : (f(t.body) || tt(t.body)) && (t.emulateJSON ? (t.body = $.params(t.body),
        ...
        e(function(t) {
            ...
            t.bodyText ? l(t.text(), function(e) {
                ...
                if (0 === n.indexOf("application/json") || A(e))
                    try {
                        t.body = JSON.parse(e)
                    } catch (e) {
                        t.body = null
      ...
      , ft = function(t, e) {
        "JSONP" == t.method && (t.client = ct),
        e()
    }
      , ht = function(t, e) {
        c(t.before) && t.before.call(this, t),
        e()
    }
      , pt = function(t, e) {
      ...
      , mt = function(t) {
        return new e(function(e) {
            ...
            "responseType"in n && lt && (n.responseType = "blob"),
      ...
      , vt = function(t) {
        function o(o) {
            return new e(function(e) {
                function s() {
                    r = i.pop(),
                    c(r) ? r.call(t, o, a) : (n("Invalid interceptor of type " + typeof r + ", must be a function"),
                    a())
                }
                function a(n) {
                    if (c(n))
    ...
    var gt = function(t, e) {
        ...
        this.status = r || 0,
        this.statusText = i || "",
        this.headers = new bt(o),
        this.body = t,
        a(t) ? this.bodyText = t : p(t) && (this.bodyBlob = t,
        B(t) && (this.bodyText = H(t)))
    };
    ...
    L.interceptors = [ht, pt, at, ft, dt, st],
