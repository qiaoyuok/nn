...
<head>
    ...
    <title><?php echo ($user["nickname"]); ?>|女娲大厅</title>
...
<script type="text/javascript">
    ...
    app.controller("myCtrl", function($scope,$http) {
        ...
        $scope.gotozj=function(){
            window.location.href = "http://hy.mips7555.cn:1688/game/playRoomList";
        }
        $scope.gotored=function(){
            window.location.href = "http://hy.mips7555.cn:1688/ay/rp";
        }
        ...
        $scope.userInfo={
            ...
            "maccountid":"<?php echo ($user["maccountid"]); ?>",
             ...
             $scope.img={
               "bull":"/files/images/gameicon/nw/ba.png",
               "laibull":"/files/images/gameicon/nw/icon_laibull.png",
               "sangong":"/files/images/gameicon/nw/sa.png",
               "flower":"/files/images/gameicon/nw/fa.png",
               "landlord":"/files/images/gameicon/nw/superld.png",
               "majiang":"/files/images/gameicon/nw/mjs.png",
               "paijiu":"/files/images/gameicon/nw/pa.png",
               "erbagang":"/files/images/gameicon/nw/28.png",
               "yxx":"/files/images/gameicon/nw/icon_yxx.png",
               "dcx":"/files/images/gameicon/nw/icon_dcx.png",
               "dxbull":"/files/images/gameicon/nw/icon_dxbull.png",
               "s13s":"/files/images/gameicon/nw/water13.png",
               "title":"/files/images/gameicon/nw/title.png",
               "bj":"/files/images/gameicon/nw/home.jpg",
               "infonew":"/files/images/gameicon/nw/info.png",
        }
 ...
 $('#Multiplehall').hide();
        ...
        $scope.getAuthcodeHttp=function(phone){
            $http({
                url:'http://hy.mips7555.cn:1688/account/getMobileSms',
                method: 'POST',
                headers:{
        ...
        $scope.bindPhoneHttp=function(phone,authcode){
            $http({
                url:'http://hy.mips7555.cn:1688/account/checkSmsCode',
                method: 'POST',
                headers:{
                    'Content-Type': 'application/x-www-form-urlencoded'
                },
        ...
        $scope.connectSocket=function(socket,type){
            ...
            $scope.ws.onmessage = function(evt){
                ...
                if (obj.result==1){
                    ...
                    $scope.is_operation=false;
                    $scope.showAlert(34,"女娲区:"+obj.result_message);
        ...
        $scope.createCommit = function () {
            if ($scope.userInfo.card!=0){
                ...
                switch($scope.createInfo.isShow){
                    case 1:
                        $scope.connectSocket("ws://替换你的域名:7451/gamedn", $scope.createInfo.isShow);
                        localStorage.bullx = JSON.stringify($scope.createInfo.bullx);
                        break;
                    case 4:
                        $scope.connectSocket("ws://替换你的域名:7451/gamezjh", $scope.createInfo.isShow);
                        localStorage.flower = JSON.stringify($scope.createInfo.flower);
                        break;
                    case 5:
                        $scope.connectSocket("ws://替换你的域名:7451/gamesg", $scope.createInfo.isShow);
                    ...
                    case 13:
                        ...
                        break;
                    case 14:
                        $scope.connectSocket("ws://替换你的域名:7451/gamelzdn", $scope.createInfo.isShow);
...
.pointIcon2{
  ...
  <script type="text/javascript">
    ...
    var shareTitle = "<?php echo ($user["nickname"]); ?>的女娲ID:" ;
