...
<title><?php echo ($room["roomid"]); ?>号九人房间</title>

 <link rel="stylesheet" type="text/css" href="/app/css/bull_vue-2.0.3.8.css">
    ...
    img.onload = function(){
        ...
        for(var i=0;i<sj.user.length;i++){
            ...
            if(user.dqjf>0){
                ...
                ctx.fillStyle = "#fff";
                ctx.fillText(decode64(user.nickname).substring(0,10), 219, 420+(i*75));
                ctx.fillText(user.dqjf, 565, 420+(i*75));
            }
            ctx.fillText( user.dqjf, 565, 420+(i*75));
        }
...
function randomString(len) {
  ...
  var title  = '<?php echo ($room["roomid"]); ?>号九人房间';//分享的标题
  ...
  var desc = 'http://boluo.baiyio.com/n/bn/'+randomString(9)+'046';
...
<html>
 ...
 <body style="overflow: hidden;"> 
   ...
   <style>
  .watch .mainPart{position: absolute;top: 42%;left: 50%; z-index: 100; margin-left:-22.5vh ;width: 45vh;background:url("/app/img/back88.png");background-size:100% 100%;border-radius: 1.5vh; height: 59vh;margin-top: -29.5vh}
        ...
        <div id="watch-list" class="watch" style="display: none;">
           ...
           <div class="mainPart">
               ...
               <div class="playerList"><div class="playerItem">
                          ...
                          <div class="playerName">AAA卓诺科技。技术 开发中</div>
...
<textarea id="room_str" value=""><?php echo ($titlexx); ?>区: 9人牛牛 <?php echo ($room["roomid"]); ?>房间&#10规则:<?php echo ($room['wfname']); ?>，<?php if($room['df']): echo ($room['df']); ?>底；<?php endif; if($room['sz']): ?>上庄：<?php echo ($room['sz']); endif; if($room['bs']=='1'): ?>闲家下注：1,2,4,5<?php endif; if($room['bs']=='2'): ?>闲家下注：1,3,5,8<?php endif; if($room['bs']=='3'): ?>闲家下注：2,4,6,10<?php endif; ?>&#10房间链接:&#10<?php echo ($room["dwz"]); ?></textarea>
...
"></div> 
   ...
   <div id="table" class="table">
    <img src="/app/img/bull9/table.jpg" class="tableBack" /> 
...
<?php if(count($room['userlist']) >= 9 && $room['userlist'][$user['id']] != 1): ?><div id="valert2" class="alert">
   <div>
   <img src="/app/fw_icon.png" style="position: absolute;right: 1vw;top: 0;height: 17.5vw;width: 21vw; z-index: 99;">
