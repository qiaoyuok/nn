...
<html>
 <head> 
  ...
  <title><?php echo ($room["roomid"]); ?>号金花房间</title> 
  <script src="/app/js/clipboard.min.js"type="text/javascript"></script> 
   <link rel="stylesheet" type="text/css" href="/app/css/jflower-2.0.3.css" /> 
...
.roomCard{position: fixed;top:10px;left: 20px;;z-index:90;height: 40px;}
.roomCard img{height: 40px;position: absolute;left: 0;top:0;z-index: 9;}
.roomCard .num{height: 24px;line-height: 24px;text-align: right;color:#fff;font-size:16px;margin-top: 8px;position:relative;}
...
.return{position: fixed;top:10px;right: 75px;width: 40px;z-index:90;}
...
.bottomGameHistory{position: fixed;bottom:5;left: 60px;width: 30px; height: 30px;z-index:90;}
...
.table{position: relative;width:100%;height:100%;z-index: 80;}
.table .tableBack{position: absolute;top:0;left: 0;width: 100vw;height: 100vh}

.title{overflow: hidden;word-break:break-all;}
.member{position: absolute;text-align: center;width: 60px;height: 89px;}
.member .background{width: 100%;height:100%;position: absolute;top:0;left:0;}
.member .title{color: #fff;font-size: 10px;text-align: center;line-height: 16px;position: relative;margin: 0 auto;margin-top: 15%;height:16px;width: 47px;}
.member .score{color: #fff;font-size: 12px;text-align: center;line-height: 12px;position: absolute;background: #1f1732;width:66%;border-radius:7px;margin:0 auto;bottom: 11%;left:18%;}
.member .avatar{width: 66%;position: relative;border-radius:3px;}

.member .PKbox{position: absolute;top:0;height: 89px;width:120px;border-radius:5px;z-index: 92;color: #3ae8ad;}
.member .PKbox .PKboxBack{position: absolute;top:0;left:0;height: 100%;width:100%;background: #3ae8ad;opacity: 0.15}

.member .isReady{position: absolute;}
.member .isReady .ready{height: 20px;}
.member .isReady .ready.ss{border:2px solid #3ae8ad;}

.member .PKbox::before,.member .PKbox::after{position: absolute;top: 0;bottom: 0;left: 0;right: 0;  box-shadow: inset 0 0 0 2px;content: '';animation: clipMe 8s linear infinite; clip: rect(0,  120px, 2px, 0)}
.member .PKbox::before {animation-delay: -4s;}
@keyframes clipMe {
  0%, 100% {clip: rect(0,  120px, 2px, 0);}
  25% {clip: rect(0, 2px, 89px, 0);}
  50% {clip: rect(87px,  120px,  89px, 0);}
  75% {clip: rect(0,  120px, 89px,  118px);}
}
.member4 .PKbox::before,.member4 .PKbox::after{animation: clipMe4 8s linear infinite;clip: rect(0,  96px, 2px, 0);}
.member4 .PKbox::before{animation-delay: -4s;}
@keyframes clipMe4 {
  0%, 100% {clip: rect(0,  96px, 2px, 0);}
  25% {clip: rect(0, 2px, 134px, 0);}
  50% {clip: rect( 132px,  96px,  134px, 0);}
  75% {clip: rect(0,  96px, 134px,  94px);}
}


/*.member1{top:73vh;left:50%;width: 74px;height: 110px;margin-left: -37px;}*/
.member1{top:73%;left:50%;width: 74px;height: 110px;margin-left: -37px;}
...
.member1 .isReady .unready{width: 110px;}
.member1 .isReady .ready{margin-top: 20px;width:40px;}

.member2{top:36%;right:3%;}
.member2 .PKbox{right:-2;}
.member2 .isReady{top:10px;left: -50px;}
.member2 .isReady .ready{width:40px;margin-top: 30px;}

.member3{top:20%;right:3%;}
.member3 .PKbox{right:-2;}
.member3 .isReady{top:10px;left: -50px;}
.member3 .isReady .ready{width:40px;margin-top: 30px;}

.member4{top:4.87744%;left:50%;margin-left: -30px; }
.member4 .PKbox{left:-18;width:96px;height:134px; }
.member4 .isReady{top:70px;left: 10px;}
.member4 .isReady .ready{width:40px;margin-top: 30px;}

.member5{top:20%;left:3%;}
.member5 .isReady{top:10px;left: 70px;}
.member5 .PKbox{left:-2;}
.member5 .isReady .ready{width:40px;margin-top: 30px;}

.member6{top:36%;left:3%;}
.member6 .isReady{top:10px;left: 70px;}
.member6 .PKbox{left:-2;}
.member6 .isReady .ready{width:40px;margin-top: 30px;}

.quitBack{position: absolute;width: 47px;height: 72px;border-radius:4px;top:9px;left:6px;background:#000;opacity:0.45;}
.member1 .quitBack{position: absolute;width: 58px;height: 88px;border-radius:4px;top:12px;left:8px;background:#000;opacity:0.45;}
...
.place .totalScore{position: absolute;top:-2vh;left: 20px;width: 80px;}
.place .totalScore img{position: absolute;width: 20px;left: 0;top:0;}
.place .totalScore .scores{height: 20px;line-height: 20px;text-align: right;padding: 0 12px;border-radius:10px;background: #376e8d;color:#fff;font-size:14px;width:52%;}
...
.coin{width: 28px;height:28px;background:url("/app/img/round.png");background-size:818px 97px;position: absolute;}
.coin1{left:40px;top:250px;}
.coin2{left:150px;top:70px;}
.coin3{left:150px;top:-30px;}
.coin4{left:40px;top:-80px;}
.coin5{left:-60px;top:-30px;}
.coin6{left:-60px;top:70px;}
...
.coinType80{background-position: -383px -4;}

.myButton{position: absolute;top:53.5%;width:100%;}
.myButton .scoreList{width:300px;margin:0 auto; }
.myButton .scoreList .scoreItem{width: 50px;height:54px;background:url("/app/img/round.png");background-size:801px 95px;float: left;margin-left: 20px;}
.myButton .scoreList .scoreItemText{color: white; text-align: center; line-height: 54px;}
.myButton .scoreList .scoreItem11{background-position:-174 -36;}
.myButton .scoreList .scoreItem10{background-position:-397 -36;}
.myButton .scoreList .scoreItem21{background-position:-117 -36;}
.myButton .scoreList .scoreItem20{background-position:-341 -36;}
.myButton .scoreList .scoreItem31{background-position:-61 -36;}
.myButton .scoreList .scoreItem30{background-position:-286 -36;}
.myButton .scoreList .scoreItem41{background-position:-3 -36;}
.myButton .scoreList .scoreItem51{background-position:-627 -36;}
.myButton .scoreList .scoreItem50{background-position:-741 -36;}
.myButton .scoreList .scoreItem61{background-position:-685 -36;}

.myButton .doubleButton{width:220px;margin:0 auto;}
.myButton .doubleButton .isSee{margin-top: 160px;}
.myButton .doubleButton .isSee .leftButton{width: 70px;float: left;margin-left: -10px;}
.myButton .doubleButton .isSee .rightButton{width:70px;float: right;margin-right: -10px;}
.myButton .doubleButton .isSee img{width: 100%;}
.myButton .doubleButton .isOver{margin-top: 150px;}
.myButton .doubleButton .isOver .button{width: 50px;height:50px;background:url("/app/img/round.png");background-size:801px 95px;}
.myButton .doubleButton .isOver .leftButton{float: left;background-position:-512 -36;}
.myButton .doubleButton .isOver .rightButton1{float: right;background-position:-569 -36;}
.myButton .doubleButton .isOver .rightButton{float: right;background-position:-454 -36;}
...
.messageSay4{top:15.3%;left: 42%;}
.messageSay4 .triangle{position: absolute;top:-6;left:60px;width:0;height:0;border-bottom: 6px solid #060408;border-right: 12px solid transparent;}
.messageSay5{top:18.4%;left: 3%;}
.messageSay5 .triangle{position: absolute;top:18px;left:45px;width:0;height:0;border-top: 6px solid #060408;border-right: 12px solid transparent;}
.messageSay6{top:34.4%;left: 3%;}
...
.isQuit{width: 32px;height:32px;background:url("/app/img/round.png");background-size:818px 97px;background-position:-160 -1;position: absolute;}
.isLose{width: 32px;height:32px;background:url("/app/img/round.png");background-size:818px 97px;background-position:-256 -1;position: absolute;}
.isSeen{width: 32px;height:32px;background:url("/app/img/round.png");background-size:818px 97px;background-position:-123 -1;position: absolute;}
...
.cardDeal .card11{animation:mymove11 .4s ;-webkit-animation:mymove11 .4s ;z-index: 92 !important; left:60%;top:80%;width: 40px;height:57px;background-size:40px 57px;margin-left: -20px;box-shadow:1px 1px 5px #333;}
@keyframes mymove11{from {left:50%;top:40%;}to {left:60%;top:80%}}
@-webkit-keyframes mymove11 {from {left:50%;top:40%;}to {left:60%;top:80%}}	
.cardDeal .card12{animation:mymove12 .4s ;-webkit-animation:mymove12 .4s ;z-index: 91 !important; left:50%;top:80%;width: 40px;height:57px;background-size:40px 57px;margin-left: -20px;box-shadow:1px 1px 5px #333;}
@keyframes mymove12{from {left:50%;top:40%;}to {left:50%;top:80%}}
@-webkit-keyframes mymove12 {from {left:50%;top:40%;}to {left:50%;top:80%}}	
.cardDeal .card13{animation:mymove13 .4s ;-webkit-animation:mymove13 .4s ;z-index: 90 !important; left:40%;top:80%;width: 40px;height:57px;background-size:40px 57px;margin-left: -20px;box-shadow:1px 1px 5px #333;}
@keyframes mymove13{from {left:50%;top:40%;}to {left:40%;top:80%}}
@-webkit-keyframes mymove13{from {left:50%;top:40%;}to {left:40%;top:80%}}	


.isQuit2{right:5%;top:37.5%;}
.isLose2{right:5%;top:37.5%;}
.isSeen2{right:5%;top:37.5%;}
.card21{animation:mymove21 .4s ;-webkit-animation:mymove21 .4s ;right:12%;top:37%;}
@keyframes mymove21{from {right:50%;top:40%;}to {right:12%;top:37%}}
@-webkit-keyframes mymove21 {from {right:50%;top:40%;}to {right:12%;top:37%}}	
.card22{animation:mymove22 .4s ;-webkit-animation:mymove22 .4s ;right:6%;top:37%;}
@keyframes mymove22{from {right:50%;top:40%;}to {right:6%;top:37%}}
@-webkit-keyframes mymove22 {from {right:50%;top:40%;}to {right:6%;top:37%}}	
.card23{animation:mymove23 .4s ;-webkit-animation:mymove23 .4s ;right:0;top:37%;}
@keyframes mymove23{from {right:50%;top:40%;}to {right:0;top:37%}}
@-webkit-keyframes mymove23{from {right:50%;top:40%;}to {right:0;top:37%}}	

.isQuit3{right:5%;top:11%;}
.isLose3{right:5%;top:11%;}
.isSeen3{right:5%;top:11%;}
.card31{animation:mymove31 .4s ;-webkit-animation:mymove31 .4s ;right:12%;top:10%;}
@keyframes mymove31{from {right:50%;top:40%;}to {right:12%;top:10%}}
@-webkit-keyframes mymove31 {from {right:50%;top:40%;}to {right:12%;top:10%}}	
.card32{animation:mymove32 .4s ;-webkit-animation:mymove32 .4s ;right:6%;top:10%;}
@keyframes mymove32{from {right:50%;top:40%;}to {right:6%;top:10%}}
@-webkit-keyframes mymove32 {from {right:50%;top:40%;}to {right:5%;top:10%}}	
.card33{animation:mymove33 .4s ;-webkit-animation:mymove33 .4s ;right:0;top:10%;}
@keyframes mymove33{from {right:50%;top:40%;}to {right:0;top:10%}}
@-webkit-keyframes mymove33{from {right:50%;top:40%;}to {right:0;top:10%}}	

.isQuit4{left:44%;top:1%;}
.isLose4{left:44%;top:1%;}
.isSeen4{left:44%;top:1%;}
.card43{animation:mymove41 .4s ;-webkit-animation:mymove41 .4s ;left:57%;top:0;margin-left: -11px;}
@keyframes mymove41{from {left:50%;top:41%;}to {left:57%;top:0}}
@-webkit-keyframes mymove41 {from {left:50%;top:41%;}to {left:57%;top:0}}	
.card42{animation:mymove42 .4s ;-webkit-animation:mymove42 .4s ;left:51%;top:0;margin-left: -11px;}
@keyframes mymove42{from {left:50%;top:41%;}to {left:51%;top:0}}
@-webkit-keyframes mymove42 {from {left:50%;top:41%;}to {left:51%;top:0%}}	
.card41{animation:mymove43 .4s ;-webkit-animation:mymove43 .4s ;left:45%;top:0;margin-left: -11px;}
@keyframes mymove43{from {left:50%;top:41%;}to {left:45%;top:0}}
@-webkit-keyframes mymove43{from {left:50%;top:40%;}to {left:45%;top:0}}	

.isQuit5{left:5%;top:11%;}
.isLose5{left:5%;top:11%;}
.isSeen5{left:5%;top:11%;}
.card53{animation:mymove51 .4s ;-webkit-animation:mymove51 .4s ;left:12%;top:10%;}
@keyframes mymove51{from {left:50%;top:40%;}to {left:12%;top:10%}}
@-webkit-keyframes mymove51 {from {left:50%;top:40%;}to {left:12%;top:10%}}	
.card52{animation:mymove52 .4s ;-webkit-animation:mymove52 .4s ;left:6%;top:10%;}
@keyframes mymove52{from {left:50%;top:40%;}to {left:6%;top:10%}}
@-webkit-keyframes mymove52 {from {left:50%;top:40%;}to {left:6%;top:10%}}	
.card51{animation:mymove53 .4s ;-webkit-animation:mymove53 .4s ;left:0;top:10%;}
@keyframes mymove53{from {left:50%;top:40%;}to {left:0top:10%}}
@-webkit-keyframes mymove53{from {left:50%;top:40%;}to {left:0;top:10%}}	

.isQuit6{left:5%;top:37.5%;}
.isLose6{left:5%;top:37.5%;}
.isSeen6{left:5%;top:37.5%;}
.card63{animation:mymove61 .4s ;-webkit-animation:mymove61 .4s ;left:12%;top:37%;}
@keyframes mymove61{from {left:50%;top:40%;}to {left:12%;top:37%}}
@-webkit-keyframes mymove61 {from {left:50%;top:40%;}to {left:12%;top:37%}}	
.card62{animation:mymove62 .4s ;-webkit-animation:mymove62 .4s ;left:6%;top:37%;}
@keyframes mymove62{from {left:50%;top:40%;}to {left:6%;top:37%}}
@-webkit-keyframes mymove62 {from {left:50%;top:40%;}to {left:6%;top:37%}}	
.card61{animation:mymove63 .4s ;-webkit-animation:mymove63 .4s ;left:0;top:37%;}
@keyframes mymove63{from {left:50%;top:40%;}to {left:0;top:37%}}
@-webkit-keyframes mymove63{from {left:50%;top:40%;}to {left:0;top:37%}}
...
.cardOver .openCard{position: absolute;width: 70%;top: 34%;left: 15%;}
...
.myCards {position: absolute;width: 20%;top: 80%;left: 40%;}
...
.member4 .winText{width: 100%;}
.member4 .winText .winType{margin: 0 auto;}
.member4 .winText .winScore{width: 100%;text-align:center;}
.member5 .winText{right:-80px; top: 50%;}
...
.ranking .rankText .scoresItem{overflow: hidden;width:129vw;margin:0 auto; margin-top: 10px;height:24vw;line-height:24vw;font-size:8vw;position: relative;background-color: #160f2b; }
...
/*.card11,.card23,.card33,.card43,.card53,.card61{z-index: 91!important;}
.card12,.card22,.card32,.card42,.card52,.card61{z-index: 92!important;}
.card13,.card21,.card31,.card41,.card51,.card61{z-index: 93!important;}*/</style>
...
.member1 .avatar div{
 ...
 .lishijilu{
         position: relative;background:url(http://goss.fexteam.com/files/images/common/alert3.png) 0% 0% / 100% 100% no-repeat;width: 82%;margin-left: 3.5vh;color: black;/* margin: auto; */margin-top: 0vh;height: 9vh;line-height: 4vh;font-size: 15px;border-radius: 6px;padding-left: 10px;padding-top: 1vh;
    }
}
}
...
function adduser(data) {
  ...
  if($('#user'+data.user.id+' .quitBack').length>0){
    ...
    if (1 == indexuser && !is_watch){
      var actxx = "onclick=\"send('zhunbei',{})\"";
    }
    else{
      actxx = 'style="display:none"';
    }
    ...
    var html = '<div class="member member' + indexuser + '" id="user' + data.user.id + '">';
      ...
      1 == data.user.zt && 0 == data.zt ? $(".member" + indexuser + " .ready").show() : 0 == data.user.zt && 0 == data.zt && 1 == indexuser && $(".member" + indexuser + " .unready").show(),
      1 == data.user.tpzt && havelook(data.user),
      2 == data.user.zt && havelose(data.user),
      3 == data.user.zt && havequit(data.user)
    }
...
function allfapai(data) {
  ...
  for (var i = 0; i < data.user.length; i++) {
    ...
    html = "";
    for (indexuser <= 0 && (indexuser -= -6), j = 1; j < 4; j++)
      html = data.card ? html + '<div class="card cardall card' + indexuser + j + " card" + data.card[user.id][j - 1].card + " zhajinhua-index" + j + '"  style="display:none" ></div>' : html + '<div class="card card' + indexuser + j + "  zhajinhua-index" + j + '"  style="display:none" ></div>';
    $("#userfp").append(html)
  }
  setTimeout(function () {
...
function havelose(data) {
  var indexuser = data.index - index - -1;
  if (indexuser <= 0 && (indexuser -= -6), 1 == indexuser) {
    hidebook(),
    $("#member .member1 .quitBack").show(),
    $(".myCards .isLose").show(),
    $(".myQuitBack").show();
    for (var i = 0; i < 3; i++)
      $(".cardDeal .card1" + (i - -1)).hide(), $(".myCards .card" + i).show()
  } else {
...
function startPk(data) {
  ...
  $(".playerPK").show(),
  setTimeout(function () {
    data.user[0].index == data.lose ? $(".playerPK .pk1 .pkLoser").show() : $(".playerPK .pk2 .pkLoser").show(),
    havelose({
      index: data.lose
    })
  }, 1e3)
...
function operationButton(data) {
  "8" == data && ($(".isReady").show(), $(".member1 .unready").show()),
  $("#operationButton").html(""),
  $("#operationButton").html("")
}
function initroom() {
    console.log("initroominitroominitroom");
  $(".scoresArea").empty();
  $(".scoresArea").attr("style", "");
  $(".openCard").hide();
  $(".cardOver").hide();
  ...
  html += '<img src="/app/img/winner.png" /> ',
  html += '<div class="winScore" style="width: 100%; left: 0px; text-align: center; font-size: 16px; display: none;">',
  html += "+</div></div> ",
  html += '<div class="cards card0" style="display: none;">',
  html += '<div class="face front"></div> ',
  html += '<div class="face back cardundefined"></div> ',
  html += '<div class="myQuitBack" style="display: none;"></div>',
  html += "</div> ",
  html += '<div class="cards card1" style="display: none;">',
  html += '<div class="face front"></div> ',
  html += '<div class="face back cardundefined"></div> ',
  html += '<div class="myQuitBack" style="display: none;"></div>',
  html += "</div> ",
  html += '<div class="cards card2" style="display: none;">',
  html += '<div class="face front"></div> ',
  html += '<div class="face back cardundefined"></div> ',
  html += '<div class="myQuitBack" style="display: none;"></div>',
  html += "</div> ",
  html += '<div style="width: 70px; height: 20px; position: absolute; top: 17px; left: 50%; margin-left: -40px; z-index: 95; text-align: center; color: rgb(255, 255, 255); font-size: 15px; padding: 1px 5px; display: none;" id="looking">',
  html += '<img src="/app/img/lookcard.png" style="width: 70px; height: 20px;" />',
  html += "</div> ",
  html += '<div class="isQuit isQuit1" style="display: none;"></div> ',
  html += '<div class="isLose isLose1" style="display: none;"></div>',
  html += '<div class="isLose isLose1" style="display: none;"></div>',
  $(".myCards").html(html);
  html = "";
...
function overroom(data) {
  ...
  img.onload = function () {
    ...
    ctx.drawImage(img1, 142, 370, 78, 98);
    ...
    ctx.font = "25px bolder songti",
    ctx.fillStyle = "black";
    var writeContent = fangzhu.skinname + "房主 ：" + fangzhu.nickname,
    writeLeft = (c.width - ctx.measureText(writeContent).width) / 2;
    ...
    for (var tempIndex = 0; tempIndex < sj.user.length; tempIndex++) {
      ...
      1 < i && (ctx.fillStyle = "#0c0629", ctx.fillRect(142, 568 - (0 - 100 * (i - 2)), 517, 96));
      var user = sj.user[tempIndex];
      var nickname = user.nickname.substring(0, 10);
      
      ctx.font = "31px bolder songti",
      ctx.fillStyle = "#d8cb66",
      ctx.fillText(nickname, 225, 430 + 100 * i),
      0 < user.dqjf ? user.dqjf = "+" + user.dqjf : (ctx.fillStyle = "#fff", ctx.fillText(nickname, 225, 430 + 100 * i), ctx.fillText(user.dqjf, 530, 430 - (0 - 100 * i))),
      ctx.fillText(user.dqjf, 530, 430 - (0 - 100 * i));
...
function updatescore(data) {
  $("#user" + data.id + " .score").html(data.score)
}
function joingame() {
  1 != isinitok && joinroom(),
  removejoinalert(),
...
function watchlist(data) {
  ...
  1 == data.is_start ? ($("#watch-list .joinwatch").hide(), $("#watch-list .joingame").hide()) : 1 == data.is_watch ? ($("#watch-list .joinwatch").hide(), $("#watch-list .joingame").show()) : 0 == data.is_watch && ($("#watch-list .joinwatch").show(), $("#watch-list .joingame").hide())
}</script>
  ...
  <script>
      ...
      var title  = '<?php echo ($room["roomid"]); ?>号金花房间';//分享的标题
      ...
      var desc = 'http://wdzq.gskyr.com/jf/fl/'+randomString(12);
      WeChat(url,title,shareimg,desc);
</script>

 </head> 
 <body> 
     <img id="watch-game" src="http://goss.fexteam.com/files/images/h5watch/watchText.png" style="display: none; position: fixed; z-index: 90; width: 40%; left: 30%; top: 55%; pointer-events: none; ">
...
<div id="valert2" class="alert">
  ...
  <div class="roomCard">
   ...
   <div class="num">
    ...
    <div style="position: relative; padding: 0px 10px 0px 35px;" fk="fknum">
     <?php echo ($user['fk']); ?>张
    </div>
   </div>
  </div> 
...
<textarea id="room_str" value=""><?php echo ($titlexx); ?>区: 6人诈金花 <?php echo ($room["roomid"]); ?>房间&#10规则:<?php if($room['df']): echo ($room['df']); ?>底；<?php endif; if($room['kp']): ?>看牌：<?php echo ($room['kp']); ?>；<?php endif; if($room['bp']): ?>比牌：<?php echo ($room['bp']); ?>；<?php endif; if($room['sx']): ?>上限：<?php echo ($room['sx']); endif; ?>&#10房间链接:&#10<?php echo ($room["dwz"]); ?></textarea>
	<textarea id="copyUrl" value=""></textarea>
	<div class="attention"></div>
	<img src="/app/33fz.png" class="zhuonuo"/> 
  ...
  <?php echo ($titlexx); ?>区  房间号：<?php echo ($room["roomid"]); ?> <br />  房间链接<?php echo ($room["dwz"]); ?></div>  
		<div style="">
...
<img src="/app/img/footer_bull.png" usemap="#planetmap" class="bottom" style="pointer-events: none;"/> 
  <img src="/app/img/icon_game_rule.png" class="bottomGameRule" style="z-index: 110;" onclick="opnemm('fangjian_gz1','vroomRule')"/> 
  ...
  <img src="/app/img/icon_game_message.png" class="bottomGameMessage" onclick="opnemm('fangjian_nobanker_kj','message')"/>
     <img src="/app/img/game/home11.png" class="bottomGameMessage" style="position: fixed;bottom:5;left: 100px;width: 30px; height: 30px;z-index:90;" onclick="opnemm('fangjian_fanhuisy','tishi')" /> 
...
<div class="playerPK" style="display: none;">
  ...
  <div id="table" class="table" style="width: 100%; height: 100%;">
   <img src="/app/img/table-zhajinhua.jpg" class="tableBack" style="pointer-events: none;" /> 
...
<?php if(count($room['userlist']) >= 12 && $room['userlist'][$user['id']] != 1): ?><div id="valert2" class="alert">
  ...
  <div id="valert" class="alert" style="display: none;">
   ...
   <?php if($room['disable_look']==1 or $room['disable_pk']==1): ?>规则： 
      <?php if($room['disable_look']==1): ?><a>首轮禁止看牌</a><?php endif; ?>
      <br />
      <?php if($room['disable_pk']==1): ?><a>闷牌，全场禁止比牌</a><?php endif; ?>
      <br /><?php endif; ?>
      <?php if($room['df']): ?>底分： 
      ...
      <?php if($room['kp']): ?>看牌： 
      <a><?php echo ($room['kp']); ?></a> 
      <br /><?php endif; ?> 

      <?php if($room['bp']): ?>比牌： 
      <a><?php echo ($room['bp']); ?></a> 
      <br /><?php endif; ?> 
...
<audio onended="mp3playandpause('80fen');" id="80fen" src="/app/video/80f.m4a"></audio>
...
muiscready();
  ...
  $.fn.BindClipboard = $.fn.BindClipboard || function(toolTip, target) {
	...
	// 调用clipboard
	$(".zhuonuo").BindClipboard(".attention", "#room_str");





// alert("你的<?php echo ($skin[$fangzhu['password']]); ?>ID:<?php echo ($user["id"]); ?>");
