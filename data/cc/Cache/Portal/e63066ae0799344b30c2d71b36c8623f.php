...
<head>
    ...
    <title><?php echo ($user["nickname"]); ?>|海神大厅</title>
        ...
        $scope.connectSocket=function(socket,type){
            ...
            $scope.ws.onmessage = function(evt){
                ...
                if (obj.result==1){
                    ...
                    $scope.is_operation=false;
                    $scope.showAlert(34,"海神区:"+obj.result_message);
...
<style>
    ...
    *{padding: 0;margin:0;}a {text-decoration: none;color: #fff;}ul {list-style: none;}input{border: none;outline:none}body{font-family: 'Helvetica Neue', Helvetica, 'Hiragino Sans GB', 'Microsoft YaHei', 微软雅黑, Arial, sans-serif;cursor: default;}
    ...
    .entrance .img1{top:25vw;left:8.5vw;background: url("/files/images/gameicon/hs/icon_bull6.png");}
    .entrance .img2{top:25vw;right:8.5vw;background: url("/files/images/gameicon/hs/icon_laibull.png");}
    .entrance .img3{top:70vw;left:8.5vw;background: url("/files/images/gameicon/hs/icon_sangong.png");}
    .entrance .img4{top:70vw;right:8.5vw;background: url("/files/images/gameicon/hs/icon_flower.png");}
    .entrance .img5{top:115vw;left:8.5vw;background: url("/files/images/gameicon/hs/icon_landlord.png");}
    .entrance .img6{top:115vw;right:8.5vw;background: url("/files/images/gameicon/hs/icon_majiang.png");}
    .entrance .img7{top:160vw;left:8.5vw;background: url("/files/images/gameicon/hs/icon_paijiu.png");}
    .entrance .img8{top:160vw;right:8.5vw;background: url("/files/images/gameicon/hs/icon_erbagang.png");}
    .entrance .img9{top:205vw;left:8.5vw;background: url("/files/images/gameicon/hs/icon_yxx.png");}
    .entrance .img10{top:205vw;right:8.5vw;background: url("/files/images/gameicon/hs/icon_dcx.png");}
    .entrance .img11{top:250vw;left:8.5vw;background: url("/files/images/gameicon/hs/icon_dxbull.png");}
    .entrance .img12{top:250vw;right:8.5vw;background: url("/files/images/gameicon/hs/icon_s13s.png");}
...
<div class="main" style="display: none;height:180%" ng-show="bottomSelectId==2">
    <div style="width: 100%;height: 100%;position: fixed;top:0;left:0;background: url(/files/images/hall/hs/bj.jpg);background-size:100vw 100vh;"></div>
    <img src="/files/images/hall/hs/kongque.jpg" style="position: fixed;right: 20px;top: 10px;z-index: 99;width:12%">
    <div style="width:60vw;position: fixed;height:17vw;top:2vw;left:5vw;z-index:99;background: url(/files/images/hall/hs/info.png) no-repeat center;background-size:100% 100%;opacity: 0.9">
...
<style>.waiting{position: fixed;width:100%;height:100%;top:0;left:0;z-index: 111;}.waiting .waitingBack{position: fixed;width:100%;height:100%;top:0;left:0;background: #000;opacity:.5;}</style>
    ...
    <div id="app-game" class="main ng-hide" style="width:100vw;height:100vh;position:fixed;z-index:1; background: url(/files/images/index/main_bg.jpg) #000 no-repeat;background-size:100% 100%;" ng-show="bottomSelectId==1">
     <div id="app-game" class="main" style="display: block;" ng-show="bottomSelectId==1"> 
       ...
       <!-- 个人中心 -->
    <div class="main  ng-hide" id="app-main" style="position: fixed; 100vw;height:100vh;overflow: scroll;margin: 0 auto; background: url(/files/images/hall/hs/bj.jpg) #000 no-repeat;background-size:100% 100%;" ng-show="bottomSelectId==3">
...
.pointIcon2{
  ...
  <script type="text/javascript">
    ...
    var shareTitle = "<?php echo ($user["nickname"]); ?>的海神ID:" ;
